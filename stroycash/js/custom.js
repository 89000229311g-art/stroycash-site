...
(function () {
  ...
  function initFloat() {
    ...
    var VK_SVG  = '<svg viewBox="0 0 24 24"><path d="M15.684 0H8.316C1.592 0 0 1.592 0 8.316v7.368C0 22.408 1.592 24 8.316 24h7.368C22.408 24 24 22.408 24 15.684V8.316C24 1.592 22.408 0 15.684 0zm3.692 17.123h-1.744c-.66 0-.862-.525-2.049-1.714-1.033-1.01-1.49-1.135-1.744-1.135-.356 0-.458.102-.458.593v1.566c0 .422-.135.677-1.253.677-1.846 0-3.896-1.12-5.337-3.202C4.894 11.05 4.18 8.747 4.18 8.317c0-.254.102-.491.593-.491h1.744c.44 0 .61.203.78.677.863 2.49 2.303 4.675 2.896 4.675.22 0 .322-.102.322-.66V9.99c-.068-1.186-.695-1.287-.695-1.71 0-.203.17-.407.44-.407h2.744c.372 0 .508.203.508.643v3.473c0 .372.17.508.271.508.22 0 .406-.136.813-.542 1.253-1.406 2.151-3.574 2.151-3.574.119-.254.322-.491.762-.491h1.744c.525 0 .643.271.525.643-.22 1.017-2.354 4.031-2.354 4.031-.186.305-.254.44 0 .78.186.254.796.78 1.203 1.253.745.847 1.32 1.558 1.473 2.049.153.474-.085.745-.576.745z"/></svg>';
    var MAX_SVG = '<svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="none"/><path d="M7 8l3.5 4.5L7 17h2l2.5-3 2.5 3h2l-3.5-4.5L16 8h-2l-2 2.8L10 8z"/></svg>';
    ...
    // Все мессенджеры добавляем через 1.5 сек (после инита Tilda)
    setTimeout(function() {
      var hasTilda = hasTildaMessengers();
